...
The test-suite (\texttt{pytest -q}) checks: the Fano bounds against the
empirical phase boundary of the main paper's Fig.~1 (a converse must lower
bound it), the closed form \eqref{eq:qform} against Monte-Carlo, the envelope
of Lemma~\ref{lem:median}, and the adaptive-vs-known recovery gap.
