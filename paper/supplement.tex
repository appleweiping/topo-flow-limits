...
equality $\Rcal=\mathrm{im}\,\bm U_\Scal$ iff $\Gam\succ0$. Consequences:
...
$\mathrm{im}\,\bm U_\Scal$, otherwise strictly smaller. Family identity:
...
\item the main paper's vortex-localization study $\leftarrow$
  ...
  ERA5/IBTrACS files).
\end{itemize}
The test-suite (\texttt{pytest -q}, 48 tests) checks: the Fano bounds against
