...
(verified to $2\times10^{-5}$ relative at $\rho_2=10^{-5}$,
...
$C_G/\rho_2^2\in[0.95,1.005]$ for $\rho_2\le10^{-2}$, subset
$C_G=\tfrac9{16}\rho_2^2$ matching the isolated-triangle exponent to
$2\times10^{-3}$ relative, and the Monte-Carlo error of the optimal test
within the $e^{-NC_G}$ envelope with empirical exponent decreasing onto
$C_G$; (vi) exact greedy covariance-atom recovery on rank-deficient $K_5$
